...
import {Focusable, Mirror, AutoScroll} from './Plugins';
...
export default class Draggable {
   ...
   * @type {Object}
   */
  static Plugins = {Mirror, Focusable, AutoScroll};
  ...
  constructor(containers = [document.body], options = {}) {
    ...
    this.addPlugin(...[Mirror, Focusable, AutoScroll, ...this.options.plugins]);
